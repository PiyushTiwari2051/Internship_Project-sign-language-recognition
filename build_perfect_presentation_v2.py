...
def build_perfect_presentation_v2():
    template_path = r'c:\Users\HP\Downloads\Internship Presentation PPTs Template Final.pptx'
    output_path = r'c:\Users\HP\Downloads\Piyush_Tiwari_Sign_Language_Recognition_V2.pptx'
    workspace_copy = r'Piyush_Tiwari_Sign_Language_Recognition_V2.pptx'
    ...
    # ==================== SLIDE 1: Precise In-Place Modification ====================
    slide1 = prs.slides[0]
    ...
    # Paragraph 1: Name of the Student -> Piyush Tiwari
    ...
    # Paragraph 2: Roll no. -> 2100270100000
    ...
    print(f"PERFECT PRESENTATION V2 saved successfully to:\n1. {output_path}\n2. {workspace_copy}")

if __name__ == '__main__':
    build_perfect_presentation_v2()
